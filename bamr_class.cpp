...
int bamr_class::compute_deriv(ubvector &pars, vec_index &pvi, 
  ...
  if (np!=np_ligo+np_src+np_dist+np_nsp) {
  ...
  while (i<np) {
    ...
    if (i>np_ligo+np_src+np_dist) { // w.r.t. M_*
