...
mpirun -n 1 ./bamr -threads 8 \
	-set aff_inv 1 -set couple_threads 1 -set n_walk 64 \
	-set store_rejects 1 -set prefix out/np \
	-set max_iters 100 -set file_update_time 1800 \
