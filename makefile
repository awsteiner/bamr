...
mlines:
	mpirun -n 12 ./bamr -threads 2 -set prefix out/ml \
	...
	-initial-point-last "out/ml_67r<rank>" \
	-mcmc > out/ml.log 2>&1 &

mpoly:
	mpirun -n 12 ./bamr -threads 2 -set prefix out/mp \
	-set aff_inv 1 -set couple_threads 1 -set n_walk 256 \
	-set max_time 259500 -set file_update_time 1800 \
	-set verbose 1 -set mcmc_verbose 2 \
	-set min_max_mass 2.0 -set norm_max 0 \
	...
	-initial-point-last "out/mp_58r<rank>" \
	-mcmc > out/mp.log 2>&1 &
